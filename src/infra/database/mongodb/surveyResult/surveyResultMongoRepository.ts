...
import { ILoadSurveyResultRepository } from '../../../../data/protocols/db/surveyResult/ILoadSurveyResultRepository';
...
export class SurveyResultMongoRepository implements ISaveSurveyResultRepository, ILoadSurveyResultRepository {
  ...
  async loadBySurveyId(surveyId: string, accountId: string): Promise<ISurveyResult> {
    const surveyResultCollection = await MongoHelper.getCollection('surveyResults');
    const query = new QueryBuilder()
      ...
      .build();
    const surveyResult = await surveyResultCollection.aggregate<ISurveyResult>(query).toArray();
